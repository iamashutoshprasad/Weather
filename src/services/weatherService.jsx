...
const getFormatedWeatherData = async (searchParams) => {
    ...
    const { lat, lon } = formatedForecastWeather
    const formatedForecastWeather = await getWeatherData('onecall', { lat, lon, exclude: 'current,minutely', units: searchParams.units }).then(formatForecastWeather);
