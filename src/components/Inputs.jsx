  ...
  return (
    <div className='flex flex-row justify-center my-6'>
      <div className='flex flex-row w-3/4 items-center justify-center space-x-4'>
        <input type='text' placeholder='Search for city....' className='text-xl font-light p-2 w-full shadow-xl focus:outline-none  lowercase rounded' />
        <UilSearch size={32} className='text-white cursor-pointer transition ease-out hover:scale-125 ' />
